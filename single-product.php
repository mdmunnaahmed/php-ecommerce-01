...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'singleProduct') {
        $pro_data = $obj->view_single_product($pdtID);
        $pros =  array();
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><a href="#" class="permal-link"><?php echo $pro['ctg_name'] ?></a></li>
                <li class="nav-item"><span class="current-page"><?php echo $pro['product_name'] ?></span></li>
            </ul>
        </nav>
    </div>
        ...
        <div class="container">
            ...
            <div id="main-content" class="main-content">
                ...
                <?php foreach ($pros as $pro) { ?>
                    <form action="cart.php" method="POST" class="sumary-product single-layout">
                        <div class="media">
                            <div class="thumb"><img src="admin/upload/<?php echo $pro['product_img'] ?>" alt="product image" width="400" height="400"></div>
                        </div>
                        <div class="product-attribute">
                            <h3 class="title"><?php echo $pro['product_name'] ?></h3>
                            <div class="rating">
                            ...
                            <span class="sku">Sku: #<?php echo $pro['product_id'] ?></span>
                            <p class="excerpt"><?php echo $pro['product_des'] ?></p>
                            <div class="price">
                                <ins><span class="currencySymbol">£</span><span class="price-amount " id="single-product-price"><?php echo $pro['product_price'] ?></span></ins>
                            </div>
                        ...
                        <div class="action-form">
                            <form class="quantity-box" method="POST">
                                <p class="title mb-3">Quantity:
                                    <?php
                                    if (isset($_POST['update-cart']) && $_POST['qty']) {
                                        $qty = $_POST['qty'];
                                        echo $qty;
                                    } else {
                                        echo "Product must be at least 1";
                                    }
                                    ?>
                                </p>
                                <div class="qty-input">
                                    <input type="number" name="qty" class="total-qty" value="<?php
                                                                                                if (isset($_POST['update-cart']) && $_POST['qty']) {
                                                                                                    $qty = $_POST['qty'];
                                                                                                    echo $qty;
                                                                                                }
                                ...
                                <button type="submit" name="update-cart" class="btn btn-success">Update Cart</button>
                            </form>
                            ...
                            <div class="buttons">
                                ...
                                <input type="hidden" name="product_img" value="<?php echo $pro['product_img'] ?>">
                                <button type="submit" name="add-to-cart btn-block" class="btn add-to-cart add-to-cart-btn">add to cart</button>
                                <p class="pull-row">
